...
{
      14,     0,    -1,    14,    15,    10,    -1,    -1,     3,    -1,
      15,     6,    15,    -1,    15,     7,    15,    -1,    15,     8,
      15,    -1,    11,    15,    12,    -1,     4,    11,    15,    12,
      -1,     5,    11,    15,    12,    -1
};
...
{
  "$end", "error", "$undefined", "NUMBER", "SQRT", "CQRT", "'+'", "'-'",
...
{
     -11,     0,   -11,   -11,   -10,    -9,     3,    25,     3,     3,
      12,     3,     3,     3,   -11,    15,    22,   -11,     1,     1,
     -11,   -11,   -11
};
...
{
       2,     8,     9,     3,     4,     5,     3,     4,     5,    13,
      10,     6,    15,    16,     6,    18,    19,    20,    11,    12,
      13,    11,    12,    13,    17,     0,     0,    21,    11,    12,
      13,    11,    12,    13,    22,    14
};

static const yytype_int8 yycheck[] =
{
       0,    11,    11,     3,     4,     5,     3,     4,     5,     8,
       6,    11,     8,     9,    11,    11,    12,    13,     6,     7,
       8,     6,     7,     8,    12,    -1,    -1,    12,     6,     7,
       8,     6,     7,     8,    12,    10
};
...
{
       0,    14,     0,     3,     4,     5,    11,    15,    11,    11,
      15,     6,     7,     8,    10,    15,    15,    12,    15,    15,
      15,    12,    12
};
...
#line 33 "calculator.y"
    { (yyval.dval) = cbrt((yyvsp[(3) - (4)].dval)); }
    break;
